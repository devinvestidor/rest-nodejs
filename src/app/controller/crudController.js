...
const router = express.Router(); //Váriavel de rota 


var pessoas = []; //Array estático de pessoas
var idPessoa = 0; //Váriavell que irá controlar os Ids gerados
...
//Exportação do controller. Variavel 'app' será passado por parâmetro
